...
import pws.pws.activity.c8.exceptions.NonexistentEntityException;
import pws.pws.activity.c8.exceptions.PreexistingEntityException;
...
public class DatamahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("pws_pws.activity.c.118_jar_0.0.1-SNAPSHOTPU");
